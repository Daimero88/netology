...
В таком случаеy необходимо реализовать в приложении систему файлового логирования. Также можно построить схемы сбора логов на бесплатном ПО OpenSearch и Sentry.  
Текстовые логи можно храним на сетевом диске и написать скрипт, который по cron'у будет искать в логах ошибки и отправлять их на почту.  
